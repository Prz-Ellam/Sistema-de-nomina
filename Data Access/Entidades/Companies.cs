...
namespace Data_Access.Entidades
{
    public class Companies
    {
        ...
        [RegularExpression(@"^[a-zA-Z0-9 ,.?@&!#'~*_;+-]+$", ErrorMessage = "La razón social que ingresó no es válida")]
        ...
        public string EmployerRegistration { get => employerRegistration; set => employerRegistration = value; }
